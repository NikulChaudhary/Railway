...
$result=mysql_query("SELECT * FROM $tbl_name WHERE f_name='$name'");
		...
		<div class="span12 well pass1">
			...
			<tr>
				<td>
					...
					<table class="table">
					<tr><td >First Name : </td> <td style="text-transform:capitalize;"><? echo $row['f_name']; ?></td></tr>
					<tr><td >Last Name : </td> <td style="text-transform:capitalize;"><? echo $row['l_name']; ?></td></tr>
					<tr><td>E-Mail : </td> <td><? echo $row['email'];?></td></tr>
					<tr><td>Dob : </td> <td><? echo $row['dob']; ?></td></tr>
					<tr><td> Gender :</td> <td><? echo $row['gender'];?></td></tr>
					<tr><td>Marital Status : </td> <td><? echo $row['marital']; ?></td></tr>
					<tr><td>Mobile No : </td> <td><? echo $row['mobile'];?></td></tr>
					<tr><td>Security Question : </td> <td><? echo $row['ques']; ?></td></tr>
					<tr><td>Answer : </td> <td><? echo $row['ans']; ?></td></tr>
					<tr><td></td> <td></td></tr>
					</table>
					</div>
				</td>
